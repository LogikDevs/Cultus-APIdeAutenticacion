...
Route::prefix('v1')->middleware('auth:api')->group(function(){
    ...
    Route::get("/followers",[FollowsController::class,"ListFollowers"]); //bearer
    Route::get("/followeds",[FollowsController::class,"ListFolloweds"]); //bearer
    Route::get("/friends",[FollowsController::class,"ListFriends"]); //bearer
    Route::post("/follow",[FollowsController::class,"Follow"]); //bearer
    Route::post("/unfollow",[FollowsController::class,"UnFollow"]); //bearer
    Route::post("/friends",[FollowsController::class,"Friend"]); //bearer
});
